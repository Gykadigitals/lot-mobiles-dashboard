...
const FRONTEND_FILE_PATH = '/Users/apple/Gyka Digitals /Developer Files /LOT Mobiles /lot-mobiles/src/data/terms-and-conditions.ts';
...
export async function GET() {
  try {
    ...
    // Extract the object part: export const termsAndConditionsData: TermsAndConditionsData = { ... };
    const match = content.match(/export const termsAndConditionsData: TermsAndConditionsData = ([\s\S]*);/);
    if (!match || !match[1]) {
...
export const termsAndConditionsData: TermsAndConditionsData = ${JSON.stringify(data, null, 2)};
`;
