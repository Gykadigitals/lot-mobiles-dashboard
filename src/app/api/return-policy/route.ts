...
const FRONTEND_FILE_PATH = '/Users/apple/Gyka Digitals /Developer Files /LOT Mobiles /lot-mobiles/src/data/return-policy.ts';
...
export async function GET() {
  try {
    ...
    // Extract the object part: export const returnPolicyData: ReturnPolicyData = { ... };
    const match = content.match(/export const returnPolicyData: ReturnPolicyData = ([\s\S]*);/);
    if (!match || !match[1]) {
...
export const returnPolicyData: ReturnPolicyData = ${JSON.stringify(data, null, 2)};
`;
