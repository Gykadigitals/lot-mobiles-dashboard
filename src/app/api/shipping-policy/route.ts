...
const FRONTEND_FILE_PATH = '/Users/apple/Gyka Digitals /Developer Files /LOT Mobiles /lot-mobiles/src/data/shipping-policy.ts';
...
export async function GET() {
  try {
    ...
    // Extract the object part: export const shippingPolicyData: ShippingPolicyData = { ... };
    const match = content.match(/export const shippingPolicyData: ShippingPolicyData = ([\s\S]*);/);
    if (!match || !match[1]) {
...
export const shippingPolicyData: ShippingPolicyData = ${JSON.stringify(data, null, 2)};
`;
